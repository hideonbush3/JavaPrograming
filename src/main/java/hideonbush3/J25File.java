...
public class J25File {
    ...
    // JVM 외부에서 사용할 수 있도록 바이트 형태로 데이터를 변환하는 행위
    public static void main(String[] args) {
        // 학생객체 생성
        Student2 std01 = new Student2(20016587, "엄준식",
        ...
        try{
            fos = new FileOutputStream(fname);  // 바이트 스트림
            oos = new ObjectOutputStream(fos);

            oos.writeObject(std01);
        } catch (Exception ex) {
            ex.getMessage();
        } finally {
            if (oos != null)
