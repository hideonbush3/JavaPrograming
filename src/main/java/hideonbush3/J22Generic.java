...
public class J22Generic {
    ...
    public static void main(String[] args) {
        ...
        // 왜냐, Object가 모든 클래스의 최상위 조상이기때문
        Object[] zoo = new Object[10];

    // 동물들을 동물원 우리에 가둠
        zoo[0] = (Object) new Lion();    // upcasting, 자손 -> 조상 형변환 생략가능
        zoo[1] = new Tiger();
        zoo[2] = new Zebra();
...
//        lionzoo.add(new Tiger());   // 컴파일타임 오류발생!
        ...
        // 제네릭 타입
        // 클래스나 메서드의 타입을 미리 정해두고 사용하는 것이 아니고,
        ...
        System.out.println(example.add(new Float(7.3), new Float(3.5)));
    }
}
